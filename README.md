...
## Estado (13-sep-2026, v0.1e publicada)
...
- **Verificación**: 190 tests del motor y del pipeline (`node --test tests/*.test.js`), 28 tests e2e con Playwright (`npx playwright test`) a 375×812 y 430×932 con capturas en `docs/capturas/` (incluidas `docs/capturas/430x932/`), más una pasada adversarial (revisor final + adversarial gratis) con sus hallazgos arreglados o refutados con motivo (v0.1c en `ola-final-report.md`, v0.1d en `adversarial-v01d-triage.md`, ambos en `.superpowers/sdd/2026-09-12-one-v0.1c-mazo-vertical/`, carpeta git-ignored).
